...
GoreConfig.Scoring = table.freeze({
	...
	--[[
		How much surplus damage is allowed to count, as a fraction of the body's
		own health.
		...
		dead" are the same fact and the interesting question is what did it and
		from how far, which is what the other three terms are for. At 0.5 the
		overkill contributes at most 0.275 of the 1.15 a gib needs — about a
