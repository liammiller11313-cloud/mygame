...
function ProjectileService:_impactRound(
	...
	--[[ Scenery spends the round, however many bodies it had left in it. The
	     classic pellet halves and bounces off a wall; that was modelled here and
	     is gone again, because the slingshot runs its own Tool's scripts now and
	     nothing this service does for it is ever reached. See
