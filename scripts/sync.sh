...
say "    pack        PaintballGun own Tool · RocketLauncher own Tool · Slingshot own Tool · Sword own Tool"
say ""
say "Any other BUILD line means Studio is not running this tree. Check the"
say "plugin is CONNECTED — a server being up is not the same as Studio being"
say "attached to it."
say ""
say "On the pack line, \"own Tool\" is the Brickbattle weapons running their own"
say "scripts, which is right. \"own Tool MISSING\" means that Tool is not in"
say "Assets.Weapons under that name and the weapon will do nothing."
say ""
